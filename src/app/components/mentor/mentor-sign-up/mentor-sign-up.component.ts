...
export class MentorSignUpComponent implements OnInit {
  constructor(
    ...
    private mentorSignupService: MentorSignupService,
  ...
  getPhoneErrorMessage() {
    return this.contactNumber.hasError("required")
      ? "You must enter a value"
      : this.contactNumber.hasError("minlength")
      ? "Enter a 10 digit number"
      : this.contactNumber.hasError("maxlength")
      ? "Enter a 10 digit number"
      : "";
  }
  ...
  getUrlErrorMessage() {
    return this.linkedinUrl.hasError("required")
      ? "You must enter a value"
      : this.linkedinUrl.hasError("pattern")
      ? "Not a valid URL"
      : "";
  }

  createMentor(): void {
    this.mentorSignupService.createMentor(this.mentor).subscribe(data => {
      let message =
